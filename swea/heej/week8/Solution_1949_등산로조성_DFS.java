...
public class Solution_1949_등산로조성_DFS {
    ...
    // [@Method] DFS - 등산로 조성
    private static void createHikingDFS(Point high, int dis) {
        // End 조건
        ...
        for (int d = 0; d < 4; d++) {
            ...
            if (map[nr][nc] >= map[high.r][high.c]) continue;

            createHikingDFS(new Point(nr, nc), dis+1);
        }
